...
public class Day22Test extends AocTestCase {
    ...
    public void example2() {
        var steps = Day22Parser.INPUT.parse("""
        ...
        assertThat(cuboids.stream()
                .mapToLong(Day22::cuboidSize).sum())
                        .isEqualTo(590_784);
    }
    ...
    public void example3() {
        var steps = Day22Parser.INPUT.parse("""
                ...
                """);
        var cuboids = CuboidSet.<Integer>create();
        steps.stream().forEach(step -> step.executeOn(cuboids));
        assertThat(cuboids.stream()
                .mapToLong(Day22::cuboidSize).sum())
                        .isEqualTo(2_758_514_936_282_235L);
    }

    @Test
    @Override
    public void part2() {
        assertThat(Day22.part2(input)).isEqualTo(1_235_484_513_229_032L);
    }
}
